...
function createCodeBlockWithCopyButton(OrigPre) {
  ...
  const CodeBlockWithCopyButton = props => {
    ...
    return _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement(OrigNode, _extends({}, props, {
      className: "copy-code-to-clipboard"
    }), _react["default"].createElement(CopyCodeToClipboardButton, {
      label: "Copy",
