...
const createCodeBlockWithCopyButton = OrigCode => {
  ...
  const CodeBlockWithCopyButton = ({
    ...
    // Render
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(OrigNode, props, children), /*#__PURE__*/_react.default.createElement(CopyCodeToClipboardButton, {
      buttonLabel,
      shouldInsertNewline,
      buttonLabelType,
